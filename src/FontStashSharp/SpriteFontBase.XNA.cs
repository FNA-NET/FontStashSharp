...
namespace FontStashSharp
{
	partial class SpriteFontBase
	{
			...
			TextStyle textStyle = TextStyle.None)
		{
			...
			return DrawText(renderer, text, position, color, rotation, origin, scale, layerDepth, characterSpacing, lineSpacing, textStyle);
		}
			...
			TextStyle textStyle = TextStyle.None)
		{
			...
			return DrawText(renderer, text, position, colors, rotation, origin, scale, layerDepth, characterSpacing, lineSpacing, textStyle);
		}
